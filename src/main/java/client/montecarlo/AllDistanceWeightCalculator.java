...
public class AllDistanceWeightCalculator implements IWeightCalculator {
    ...
    public double calculateWeight(SensorDataSet robotSensor, IMoveController particle) throws ActionException {
        ...
        double r1 = Helper.lerp(robotSensor.getDistanceLeft()*100 , 255.0);
        double r2 = Helper.lerp(robotSensor.getDistanceFront() *100, 255.0);
        double r3 = Helper.lerp(robotSensor.getDistanceRight()*100 , 255.0);
        ...
        double delta2 = r2 - p2;
        double delta3 = r3 - p3;
        double weight =Helper.getWeight(delta1*2.0) * Helper.getWeight(delta2*2.0) * Helper.getWeight(delta3*2.0);
